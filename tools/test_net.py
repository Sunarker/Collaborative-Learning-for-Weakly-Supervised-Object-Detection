...
from model.test_train import test_train_net
...
if __name__ == '__main__':
  ...
  filename = tag + '/' + filename  #defalut/vgg16_faster_rcnn_iter_15000
  ...
  if args.imdb_name[-4:] == 'test':
      ...
      test_train_net(net, imdb, filename, max_per_image=args.max_per_image)